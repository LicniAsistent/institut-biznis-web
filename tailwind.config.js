...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Primary Green - Growth, Success, Money
        primary: {
          50: '#f0fdf4',
          100: '#dcfce7',
          200: '#bbf7d0',
      ...
      backgroundImage: {
        ...
        'card-gradient': 'linear-gradient(145deg, var(--tw-gradient-from), var(--tw-gradient-to))',
      },
      ...
      animation: {
        ...
        'unlock-glow': 'unlockGlow 2s ease-out infinite',
      },
